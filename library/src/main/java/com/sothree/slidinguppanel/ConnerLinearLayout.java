...
/**
 * Created by hieu19926@gmail.com on 04/07/2020.
 */
public class ConnerLinearLayout extends LinearLayout {
    ...
    private Bitmap createMask(int width, int height) {
        ...
        canvas.drawRect(0, 0, width, height, paints);

        paints.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        canvas.drawRoundRect(new RectF(0, 0, width, height), cornerRadius, cornerRadius, paints);
